					...
					<div class="container-fluid">
						<form action="" id="billing-form">
							...
							<div class="form-group">
								<label for="penalty_option" class="control-label">Penalty Option</label>
								<select name="penalty_option" id="penalty_option" class="form-control form-control-sm rounded-0" required>
									<option value="" <?= isset($penalty_option) && $penalty_option == '' ? 'selected' : '' ?>>Select penalty...</option>
									<option value="10%_per_month_after_due_date" <?= isset($penalty_option) && $penalty_option == '10%_per_month_after_due_date' ? 'selected' : '' ?>>10% per Month after due date</option>
								</select>
							</div>
							<div class="form-group">
